...
import ProfileArticles from "../../src/routes/Profile/ProfileArticles";
...
describe("ProfileArticles Route", () => {
    beforeEach(() => {
        jest.clearAllMocks();
    });
    ...
    describe("loading state", () => {
        it("should display loading state initially", () => {
            ...
            expect(
                screen.getByText(/Loading testuser articles.../),
            ).toBeInTheDocument();
        });
    ...
    describe("empty state", () => {
        it("should display empty message when user has no articles", () => {
            const useArticles = require("../../src/hooks/useArticles");
            useArticles.mockReturnValue({
                articles: [],
                articlesCount: 0,
            ...
            expect(
                screen.getByText("testuser doesn't have articles."),
            ).toBeInTheDocument();
        });
    ...
    describe("hook integration", () => {
        ...
        it("should call useArticles with profile location", () => {
            const useArticles = require("../../src/hooks/useArticles");
            useArticles.mockReturnValue({
                articles: [],
                articlesCount: 0,
    ...
    describe("component styling", () => {
        it("should use article-preview class", () => {
            ...
            const { container } = render(<ProfileArticles />);
